#ifndef CS40_PNG_WRITER_H
#define CS40_PNG_WRITER_H
...
class png_writer {
  public:
    ...
    /*Attempt to write a png file to fname with given height and width
     *overwrite existing file if overwrite is set to true. Check isValid
     *after calling constructor to see if you can successfully write
     *to file. Trying to create a overwrite an existing file without 
     *overwrite set to true throws a runtime_error
     */
    ...
    /*Return true if object is valid and ready to write, false otherwise*/
