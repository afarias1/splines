#ifndef CS40_RGBIMAGE_H
#define CS40_RGBIMAGE_H
...
class RGBImage{
  public:
    ...
    /*Create a new RGBImage with specified size and background Color
      (default black)*/
    RGBImage(int height, int width, const RGBColor& background=RGBColor(0,0,0));
    ...
    /*Return a reference to a pixel color. This pixel value can be changed
     through the reference, e.g., img(row,col)=color
